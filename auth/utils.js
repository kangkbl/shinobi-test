...
module.exports = function(s,config,lang){
    ...
    function createTwoFactorAuth(user,machineId,pageTarget,req){
        console.log('===== CREATE TWO FACTOR =====');
	...
	const userDetails = user.details
		...
		console.log('FACTOR AUTH INFO');
                console.dir(factorAuthObject.info, { depth: null });
